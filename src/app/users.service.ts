...
export class UsersService {
  ...
  PartnerRevenueRecords(): Observable<any> {
    ...
    let result = this.httpclient.get<any>(`${this.HostURL}/api/CareCoOrdinators/getPartnerRevenueRecords`, httpOptions)
    return result;
...
let result = this.httpclient.get<any>(`${this.HostURL}/api/partnertasks/partnerReportingEmployees?EmployeeID=`+ EmployeeID, httpOptions)
